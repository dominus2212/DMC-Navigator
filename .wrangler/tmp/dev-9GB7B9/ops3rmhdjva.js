...
// .wrangler/tmp/pages-ExU9PG/bundledWorker-0.08132272469898238.mjs
  ...
  function we(e, t) {
    ...
    for (var s = {}, r = t || {}, a = r.decode || Ne, o = 0; o < e.length; ) {
      ...
      if (s[c] === void 0) {
        ...
        p.charCodeAt(0) === 34 && (p = p.slice(1, -1)), s[c] = je(p, a);
      }
      o = i + 1;
    }
    return s;
...
async function S(e, { request: t, assetsFetcher: s, ctx: r }, { path: a, searchParams: o }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = N(await s.fetch(I(c, e.path ?? a))), e.headers && f(n.headers, e.headers);
        break;
      }
      case "static": {
...
function he(e, t) {
  ...
  if (!p && !t?.domains?.includes(i.hostname) && !t?.remotePatterns?.find((v) => pe(i, v))) return;
...
async function Z(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let o = z(e, xe), n = await r.get(a, { softTags: o });
      ...
      case "POST": {
        let o = globalThis[ge], n = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
          i.data.tags === void 0 && (i.tags ??= z(e, me) ?? []), await r.set(a, i);
        }, "n");
...
function ye() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return r || (r = await Z(s), r) ? r : (ve(s), e(s));
  };
}
__name(ye, "ye");
__name2(ye, "ye");
async function Te(e) {
  if (e.url.startsWith("blob:")) try {
    let s = `./__next-on-pages-dist__/assets/${new URL(e.url).pathname}.bin`, r = (await j(s)).default, a = { async arrayBuffer() {
      return r;
    }, get body() {
...
var E = class {
  ...
  applyRouteDest(t, s, r) {
    ...
    return y(this.searchParams, v.searchParams), b(this.path) || (this.path = v.pathname), a;
  }
  ...
  async checkPhase(t) {
    ...
    let a = "miss";
    return r || t === "miss" || t === "error" ? a = "hit" : s && (a = H(t)), this.checkPhase(a);
  }
  async run(t = "none") {
...
async function Ce(e, { path: t = "/404", status: s, headers: r, searchParams: a, body: o }, n) {
  ...
  let p = r.normal;
  return f(p, c.headers), f(p, r.important), c = new Response(c.body, { ...c, status: s || c.status, headers: p }), c;
}
__name(Ce, "Ce");
__name2(Ce, "Ce");
u();
...
var Nr = { async fetch(e, t, s) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => o.run({ env: t, ctx: s, cf: e.cf }, async () => {
...
// .wrangler/tmp/pages-ExU9PG/ops3rmhdjva.js
...
// .wrangler/tmp/bundle-RXST47/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RXST47/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=ops3rmhdjva.js.map
