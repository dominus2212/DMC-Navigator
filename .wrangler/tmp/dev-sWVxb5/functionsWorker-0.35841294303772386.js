...
// .wrangler/tmp/pages-Wu9CzH/functionsWorker-0.35841294303772386.mjs
...
var err401 = /* @__PURE__ */ __name2((msg = "Not authenticated") => jsonError("UNAUTHENTICATED", msg, 401), "err401");
var err403 = /* @__PURE__ */ __name2((msg = "Forbidden") => jsonError("FORBIDDEN", msg, 403), "err403");
var err404 = /* @__PURE__ */ __name2((msg = "Not found") => jsonError("NOT_FOUND", msg, 404), "err404");
var err400 = /* @__PURE__ */ __name2((msg = "Validation error", fields) => jsonError("VALIDATION_ERROR", msg, 400, fields ? { fields } : void 0), "err400");
...
__name2(requireAgencyContextBySlug, "requireAgencyContextBySlug");
...
__name2(getEffectiveItineraryRole, "getEffectiveItineraryRole");
...
__name2(isValidSlug, "isValidSlug");
function uuid() {
...
__name2(cookieAttrs, "cookieAttrs");
...
__name(requireUser2, "requireUser2");
__name2(requireUser2, "requireUser");
...
// .wrangler/tmp/bundle-8mYebh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8mYebh/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.35841294303772386.js.map
